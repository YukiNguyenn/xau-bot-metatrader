            ...
            for trade in open_trades[:]:
                ...
                if trade_type == 'BUY':
                    if current_price >= tp or current_price <= sl:
                        ...
                        self.logger.info(f"Closed BUY trade @ {result_price:.2f}, Profit={profit:.2f}, Balance={current_balance:.2f}")
                    ...
                    if current_price <= tp or current_price >= sl:
                        ...
                        results['trades'].append(trade)
                        open_trades.remove(trade)
                        self.logger.info(f"Closed SELL trade @ {result_price:.2f}, Profit={profit:.2f}, Balance={current_balance:.2f}")
